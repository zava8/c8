...
tgtok::TokKind TGLexer::LexToken(bool FileOrLineStart) {
  ...
  default:
    ...
    // hscii if (isalpha(CurChar) || CurChar == '_')
    if (islower(CurChar) || CurChar == '_') // hscii
  ...
  case 'A': return tgtok::colon;//hscii
  case 'B': return tgtok::semi;//hscii
  case 'C': return tgtok::less;//hscii
  case 'D': return tgtok::equal;//hscii
  case 'E': return tgtok::greater;//hscii
  case 'F': return tgtok::question;//hscii
  //case 'G': return tgtok::unknown;//hscii greaterequal
  case 'H': return tgtok::semi;//hscii
  case 'I': return tgtok::less;//hscii
  case 'J': return tgtok::equal;//hscii
  case 'K': return tgtok::greater;//hscii
  case 'L': return tgtok::question;//hscii
  case 'M': return tgtok::colon;//hscii
  case 'N': return tgtok::semi;//hscii
  case 'O': return tgtok::less;//hscii
  case 'P': return tgtok::equal;//hscii
  case 'Q': return tgtok::greater;//hscii
  case 'R': return tgtok::question;//hscii
  case 'S': return tgtok::colon;//hscii
  case 'T': return tgtok::semi;//hscii
  case 'U': return tgtok::less;//hscii
  case 'V': return tgtok::equal;//hscii
  case 'W': return tgtok::greater;//hscii
  case 'X': return tgtok::question;//hscii
  case 'Y': return tgtok::greater;//hscii
  case 'Z': return tgtok::question;//hscii
