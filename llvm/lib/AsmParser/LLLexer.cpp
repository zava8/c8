...
lltok::Kind LLLexer::LexToken() {
  while (true) {
    ...
    default:
      ...
      // if (isalpha(static_cast<unsigned char>(CurChar)) || CurChar == '_') //hscii_small
        // return LexIdentifier(); //hscii_small

      // Handle letters: [a-zA-Z_]
      if (islower(static_cast<unsigned char>(CurChar)) || CurChar == '_') //hscii_small
        return LexIdentifier(); //hscii_small
      return lltok::Error;
    ...
    case '.':
      ...
      return lltok::Error;
    case 'A': return lltok::colon;//hscii
    case 'B': SkipLineComment(); continue;//hscii
    case 'C': return lltok::less;//hscii
    case 'D': return lltok::equal;//hscii
    case 'E': return lltok::greater;//hscii
    ...
    case '-': return LexDigitOrNegative();
